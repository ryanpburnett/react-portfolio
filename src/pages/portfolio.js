...
const Portfolio = () => {
    ...
    <>
        ...
        <div class="portfolio column">
            ...
            <p class="body-text">This site is a lyric finder site that generates lyrics for any song, along with a QR code linking to related YouTube videos.  This project was done in conjuction with three of my collegues in the Northwestern Illinois University coding boot camp.  We used the HappiDev music API and the QR code generator API</p>
